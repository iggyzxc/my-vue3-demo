                ...
                <v-col class="text-center">
                  <v-hover v-slot="{ hover }">
                    <v-btn
                      ...
                      :ripple="{ center: true }"
                      :style="{
                        'background-color': hover ? 'inherit' : '#33db14',
                      }"
          ...
          >
            ...
            >
              ...
              <v-card-text :style="{fontFamily: 'Helvetica, Arial'}" class="text-center">
                <p>
                  <strong>Area: &nbsp;</strong>{{ areaSquare }}<br />
                </p>
              </v-card-text>
            </div>
          </v-card>
...
export default {
  ...
  computed: {
    ...
    result() {
      this.areaSquare = this.num * this.num;
