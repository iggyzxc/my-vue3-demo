                ...
                <v-col class="text-center">
                  <v-hover v-slot="{ hover }">
                    <v-btn
                      ...
                      :ripple="{ center: true }"
                      :style="{
                        'background-color': hover ? 'inherit' : '#e3d61b',
                      }"
          ...
          >
            ...
            >
              ...
              <v-card-text :style="{fontFamily: 'Helvetica, Arial'}" class="text-center">
                <p>
                  <strong>Area: &nbsp;</strong>{{ areaTriangle }}<br />
                </p>
              </v-card-text>
            </div>
          </v-card>
...
export default {
  ...
  data() {
    return {
      titleMsg: "Triangle",
      descMsg: "Area of Triangle = 1/2 x (Base x Height) ",
      loader: null,
      loading4: false,
      num1: '',
      num2: '',
  ...
  computed: {
    ...
    result() {
      this.areaTriangle = 1/2* (this.num1 * this.num2);
